...
gap_dihgroup_sym = om.OMSymbol("DihedralGroup", "scscp_transient_1")
#gap_orbit_sym = om.OMSymbol("orbit_of_list", "scscp_transient_1")
gap_orbit_sym = om.OMSymbol("Orbit", "scscp_transient_1")
# gap_on_poly_sym = om.OMSymbol("OnMultivariatePolynomialsVariables", "scscp_transient_1")

glob_symgroup_sym = om.OMSymbol("symmetric_group", "permgp2")
glob_dihgroup_sym = om.OMSymbol("dihedral_group", "permgp2")
...
glob_perm_sym = om.OMSymbol("action", "permutation1")
...
mmt_client.heads.mitm_transient.registerFunction([gap_server, gap_dihgroup_sym, glob_dihgroup_sym])
# mmt_client.heads.mitm_transient.registerFunction([gap_server, gap_on_poly_sym, glob_perm_sym])
